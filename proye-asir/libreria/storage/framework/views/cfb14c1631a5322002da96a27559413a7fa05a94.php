...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-primary">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#">
                ...
                <img src="<?php echo e(URL::asset('/imagenes/libreria1.png')); ?>" width="200" alt="logo">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="hi.blade.php">Registro usuario</a></li>
        ...
        <div class="container-md p-5" >
            ...
            <div class="row" >
                ...
                <div class="card w-100" card-border mb-5>
                    <img src="imagenes/osamu2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">titulo</h5>
                        <p class="card-text">algo que escribir</p>
            ...
            <div class="row py-5">
            <div class="col">
            <h3 class="text-center" style="color:blue">clica este link</h3>
        </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-2"><a href="#">link1</a></div>
            <div class="col-2"><a href="#">link2</a></div>
            <div class="col-2"><a href="#">link3</a></div>
        </div>
    </div>
    </div>
    <!--separdor-->
    ...
    <a href="#">
        <button class="btn-lg rounded-pill btn-warning w-10 p-3 shadow-sm font-wight-bold">atencion al cliente</button>

    </a>

    </div>
    </div>
    <!--container-fluid para que se vea bien a pantalla completa-->
...
<footer >
    <div class="container-fluid">
        ...
        <div class="col-xs-12 col-md-6 col-lg-3">
            ...
            <div class="mb-3">
                <a class="text-white text-decoration-noone" href="#">Terminos y condiciones</a>
                </div>
                <div class="mb-3">
                    <a class="text-white text-decoration-noone" href="#">Politica de privacidad</a>
                    </div>
        </div>


        <div class="col-xs-12 col-md-6 col-lg-3">
            <p class="h5 mb-3">prueba</p>
            <div class="mb-3">
            <a class="text-white text-decoration-noone" href="#">Contacta con nosotros</a>
            </div>
        ...
        <div class="col-xs-12 col-md-6 col-lg-3">
            <p class="h5 mb-3">Redes social</p>
            <div class="mb-3">
                <a class="text-white text-decoration-noone" href="#">Facebook</a>
                </div>
                <div class="mb-3">
